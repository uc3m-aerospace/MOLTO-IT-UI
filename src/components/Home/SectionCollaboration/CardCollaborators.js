...
const CardCollaborators = (props) => {
  ...
  return  <React.Fragment>
                ...
                <a style={{alignItems: "center", display: "flex", justifyContent: "center"}} href="https://twitter.com" ><FontAwesomeIcon style={{color:"#0e76a8"}} icon={faTwitter} size="1x"/><span style={{fontFamily:"AvertaRegular", color: "white", marginLeft: "10px"}}>/{props.name}</span></a>
                <p>{props.body}</p>
          </React.Fragment>
}
